<template>
  <el-dialog :append-to-body="true" :close-on-click-modal="false" :before-close="cancel" :visible.sync="dialog"  width="700px">
    <el-card>
      ...
      <div class="text item">收货人:Albert Cabot Costa</div>
      <div class="text item">邮箱: zod.kawa@gmail.com</div>
      <div class="text item">联系电话:+34 690012863</div>
            <div class="text item">收货地址:Avenida Roma 159 Bajos (Tienda BMW),Barcelona,Spain  08011  </div>
      <!--      <div class="text item">-->
...
<!--      </div>-->
      ...
      <div class="text item">用户备注:Gift for collaborator</div>
    </el-card>
    <el-card>
      <div slot="header">
        <span>订单信息</span>
      ...
      <el-row :gutter="24">
        <el-col :span="12">
          <div class="text item">订单编号: 1327980683271864320</div>
          <div class="text item">商品总数: 1 </div>
          <div class="text item">Shipping Method: expedited</div>
          <div class="text item">支付邮费: 0</div>  <!-- totalPostage-->
          <div class="text item">payPrice:$60</div>
          <div class="text item">支付方式: paypal</div>
        </el-col>
        <el-col :span="12">
          <div class="text item">订单状态: 已收货</div>
          <div class="text item">商品总价: $60</div>
          <div class="text item">优惠券金额:0</div>
          <div class="text item">创建时间: 2020-11-10 22:24:05</div>
          <div class="text item">支付时间:2020-11-10 22:28:15</div>
        </el-col>
      </el-row>
    </el-card>
    <el-card>
